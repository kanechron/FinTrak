  ...
  return (
    <div ref={setNodeRef} style={style} className="flex items-stretch gap-1">
      <span
        {...attributes}
        {...listeners}
        className="flex items-center cursor-grab text-gray-600 hover:text-gray-400 select-none px-1"
      >
        ⠿
      </span>
      <div
        onClick={onClick}
        className="flex-1 space-y-1.5 border border-gray-800 rounded-lg p-3 cursor-pointer hover:border-gray-600 hover:bg-gray-800/40 transition-colors"
      >
